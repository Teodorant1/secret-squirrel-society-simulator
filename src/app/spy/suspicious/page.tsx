...
export default function SuspiciousPage() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-background">
      ...
      <canvas
        ref={canvasRef}
        className="fixed inset-0 h-full w-full opacity-30"
        width={1920}
        height={1080}
      />

      <div className="container relative z-10 mx-auto space-y-6 py-12">
        {/* Mysterious Header */}
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        <Card className="relative overflow-hidden p-6">
          ...
          <div className="grid h-32 grid-cols-8 gap-1">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <Card className="relative overflow-hidden p-6">
            ...
            <div className="relative h-[200px] overflow-hidden font-mono text-sm">
              <motion.div
        ...
        <Card className="relative overflow-hidden p-6">
          <div className="mb-6 flex items-center justify-between">
            ...
            >
              <Badge
                variant="outline"
                className={anomalyLevel > 75 ? "bg-destructive/10" : ""}
              >
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-2">
              {Array.from({ length: 9 }).map((_, i) => (
                <motion.div
                  key={i}
                  className="relative aspect-square overflow-hidden rounded bg-primary/10"
                  animate={{
                    opacity: [0.3, 0.7, 0.3],
                  }}
                  transition={{
