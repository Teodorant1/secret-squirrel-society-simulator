    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        <div className="space-y-2">
          ...
          <Input id="faction1" value={faction1Name} onChange={(e) => setFaction1Name(e.target.value)} />
          <ImageUpload label="Faction 1 Symbol" />
        </div>
        <div className="space-y-2">
          <Label htmlFor="faction2">Faction 2 Name</Label>
          <Input id="faction2" value={faction2Name} onChange={(e) => setFaction2Name(e.target.value)} />
